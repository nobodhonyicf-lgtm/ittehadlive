                ...
                <Card className="border-2 border-primary/30 print:border-black print:shadow-none" id="result-card">
                  ...
                  <CardContent className="p-6 print:p-4">
                      ...
                      <table className="w-full border-collapse text-sm border-2 border-primary/30 print:border-black">
                        ...
                        <tbody>
                          {resultsWithGrade?.map((r, i) => {
                            ...
                            return (
                              <tr key={r.id} className={`${i % 2 === 0 ? "bg-card print:bg-white" : "bg-secondary/30 print:bg-gray-50"} ${failed ? "text-destructive print:text-black" : ""}`}>
                        ...
                        <tfoot>
                          <tr className="bg-primary/10 print:bg-gray-100 font-bold">
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-4 text-center text-sm">
                      <div className="p-3 bg-secondary/50 print:bg-gray-50 rounded border">
                        <p className="text-muted-foreground print:text-black">মোট নম্বর</p>
                        <p className="text-xl font-bold text-primary print:text-black">{toBengali(totalMarks)} / {toBengali(totalFull)}</p>
                      </div>
                      <div className="p-3 bg-secondary/50 print:bg-gray-50 rounded border">
                        <p className="text-muted-foreground print:text-black">জিপিএ</p>
                        <p className="text-xl font-bold text-primary print:text-black">{toBengali(overallGPA.toFixed(2))}</p>
                      </div>
                      <div className={`p-3 rounded border ${passed ? "bg-green-50 print:bg-gray-50" : "bg-red-50 print:bg-gray-50"}`}>
                        <p className="text-muted-foreground print:text-black">ফলাফল</p>
                        <p className={`text-xl font-bold ${passed ? "text-green-600" : "text-destructive"} print:text-black`}>
                    ...
                    <div className="mt-12 flex justify-between items-end px-4">
                      <div className="text-center">
                        {getSetting("signature_controller") && (
                          <img src={getSetting("signature_controller")} alt="পরীক্ষা নিয়ন্ত্রকের স্বাক্ষর" className="h-12 mx-auto mb-1" />
                        )}
                        <div className="border-t-2 border-foreground print:border-black pt-1 min-w-[150px]">
                          <p className="text-sm font-semibold">পরীক্ষা নিয়ন্ত্রক</p>
                        </div>
                      </div>
                      <div className="text-center">
                        {getSetting("signature_principal") && (
                          <img src={getSetting("signature_principal")} alt="প্রধান শিক্ষকের স্বাক্ষর" className="h-12 mx-auto mb-1" />
                        )}
                        <div className="border-t-2 border-foreground print:border-black pt-1 min-w-[150px]">
