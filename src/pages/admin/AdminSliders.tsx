...
const AdminSliders = () => {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ["admin_sliders"] });
  ...
  const resetForm = () => {
    setEditId(null);
    setForm({ title: "", image_url: "", link: "", sort_order: 0 });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      {sliders?.length === 0 && <p className="text-center text-muted-foreground">কোনো স্লাইড নেই।</p>}
    </div>
  );
};
