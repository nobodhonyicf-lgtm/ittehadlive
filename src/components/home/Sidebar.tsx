...
import { User, Clock, Sunrise, Sun, CloudSun, Sunset, Moon, Coffee, Timer, MapPin } from "lucide-react";
    ...
    <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm">
      ...
      {!!forbiddenTimes.length && (
        <div className="border-t border-border bg-muted/20 px-4 py-4">
          <ForbiddenPrayerTimesList items={forbiddenTimes} title="আজকের নিষিদ্ধ সময়" />
        </div>
      )}
