...
const NotificationBell = () => {
  ...
  return (
    ...
    >
      <Bell size={18} />
      {unreadCount > 0 && (
        <span className="absolute top-0.5 right-0.5 min-w-[16px] h-4 flex items-center justify-center rounded-full bg-destructive text-primary-foreground text-[9px] font-bold px-1 leading-none animate-pulse">
